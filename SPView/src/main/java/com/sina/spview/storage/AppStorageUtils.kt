 ...
 */
package com.sina.spview.storage
...
import com.sina.spview.enms.FileType
import com.sina.spview.extviews.FileUtils
import com.sina.spview.utils.MimeType
...
object AppStorageUtils {
    val baseDirectory: File = File(Environment.getExternalStorageDirectory(), "Android/data/com.teamyar/files")
