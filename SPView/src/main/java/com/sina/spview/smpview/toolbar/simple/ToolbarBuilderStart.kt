package com.sina.spview.smpview.toolbar.simple
...
interface ToolbarBuilderStart {
    fun setTitle(title: String): ToolbarBuilderStart
    fun setSubtitle(subtitle: String): ToolbarBuilderStart
    fun setMenu(menuRes: Int): ToolbarBuilderAfterMenu
    fun setSearchViewId(searchViewId: Int): ToolbarBuilderStart
}
...
class ToolbarBuilder internal constructor(
    ...
    companion object {
        fun with(context: Context, toolbar: Toolbar): ToolbarBuilderStart {
            return ToolbarBuilder(context, toolbar)
        }
    }

    override fun setTitle(title: String): ToolbarBuilderStart = apply {
        this.title = title
    }

    override fun setSubtitle(subtitle: String): ToolbarBuilderStart = apply {
    ...
    override fun setSearchViewId(searchViewId: Int): ToolbarBuilderStart = apply {
