...
//                circleScaleProgress = 0.8f // Initial slightly smaller scale when checked
//            }
//        }
//
//        isClickable = true
...
//        val checkmarkStartX = centerX - radius / 3f
//        val checkmarkStartY = centerY - radius / 6f
//        val checkmarkMidX = centerX - radius / 10f
//        val checkmarkMidY = centerY + radius / 3f
//        val checkmarkEndX = centerX + radius / 2f
//        val checkmarkEndY = centerY - radius / 4f
//
//        path.reset()
...
//
//        // Draw the circle
//        val currentRadius = circleBounds.width() / 2f * circleScaleProgress
...
//
//        // Draw the fill when checked and animating
//        if (checkmarkProgress > 0f && checkmarkProgress < 1f) {
//            canvas.drawCircle(centerX, centerY, currentRadius * checkmarkProgress, fillPaint)
//        } else if (isChecked) {
//            canvas.drawCircle(centerX, centerY, currentRadius, fillPaint)
//        }
//
//        // Draw the checkmark with animation
//        if (checkmarkProgress > 0f) {
//            val measure = PathMeasure(path, false)
//            val animatedPath = Path()
//            measure.getSegment(0f, measure.length * checkmarkProgress, animatedPath, true)
...
//        isChecked = !isChecked
//
//        val checkmarkAnimator = ValueAnimator.ofFloat(if (isChecked) 0f else 1f, if (isChecked) 1f else 0f).apply {
